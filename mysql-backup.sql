...
--
-- Host: 127.0.0.1    Database: B-Huy_Chanchhinghoir-db
-- ------------------------------------------------------
...
CREATE TABLE `profiles` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_66yiwv2n5ntj3i3m0tj36x2yw` (`registration_number`),
  UNIQUE KEY `UK_fetebim4s6b2yrqmjjwuakic9` (`uuid`),
...
CREATE TABLE `templates` (
  ...
  `template_type` enum('EMPLOYEE','STUDENT','USER') NOT NULL,
  `text_color` varchar(7) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_q29dtfrj97gkqt015sdyurqcm` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-17 18:40:23
